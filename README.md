...
第四章：这个章节主要绘制出了系统功能架构，让我们更直观了解航空信息管理系统的功能，对后台数据库表进行了设计，还画出了对应的Ｅ－Ｒ图。
...
![使用帮助](/md/blog.008.jpeg "使用帮助")
图4.1 使用帮助实体属性图

（2）下图是飞机票购买订单实体和其具备的属性。

![飞机票购买订单](/md/blog.009.jpeg "飞机票购买订单")
图4.2 飞机票购买订单实体属性图

（3）下图是飞机票实体和其具备的属性。

![飞机票](/md/blog.010.jpeg "飞机票")
图4.3 飞机票实体属性图

（4）下图是航班管理动态实体和其具备的属性。

![航班管理动态](/md/blog.011.jpeg "航班管理动态")
图4.4 航班管理动态实体属性图

（5）下图是飞机票收藏实体和其具备的属性。

![飞机票收藏](/md/blog.012.jpeg "飞机票收藏")
图4.5 飞机票收藏实体属性图

（6）下图是飞机票评价实体和其具备的属性。

![飞机票评价](/md/blog.013.jpeg "飞机票评价")
图4.6 飞机票评价实体属性图

（7）下图是客户实体和其具备的属性。

![客户](/md/blog.014.jpeg "客户")
图4.7 客户实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|feijipiao\_uuid\_number|String|航班编号|是|
|3|hangkonggongsi\_bianhao|String|航空公司编号|是|
|4|hangkonggongsi\_name|String|航空公司名称|是|
|5|feijipiao\_name|String|飞机票名称|是|
|6|feijipiao\_photo|String|飞机票照片|是|
|7|feijipiao\_types|Integer|飞机票类型|是|
|8|zuowei\_number|Integer|座位|是|
|9|feijipiao\_price|Integer|购买获得积分|是|
|10|feijipiao\_old\_money|BigDecimal|飞机票原价|是|
|11|feijipiao\_new\_money|BigDecimal|现价|是|
|12|feijipiao\_clicknum|Integer|点击次数|是|
|13|cangwei\_types|Integer|舱位|是|
|14|chufadi\_types|Integer|出发地|是|
|15|mudidi\_types|Integer|目的地|是|
|16|tejia\_types|Integer|是否特价票|是|
|17|feijipiao\_content|String|飞机票介绍|是|
|18|shangxia\_types|Integer|是否上架|是|
|19|feijipiao\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|feijipiao\_id|Integer|飞机票|是|
|3|kehu\_id|Integer|客户|是|
|4|feijipiao\_collection\_types|Integer|类型|是|
...
|2|feijipiao\_id|Integer|飞机票|是|
|3|kehu\_id|Integer|客户|是|
|4|feijipiao\_commentback\_text|String|评价内容|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|feijipiao\_order\_uuid\_number|String|订单号|是|
|3|feijipiao\_id|Integer|飞机票|是|
|4|kehu\_id|Integer|客户|是|
|5|feijipiao\_order\_true\_price|BigDecimal|实付价格|是|
|6|buy\_zuowei\_number|String|购买的座位|是|
|7|buy\_zuowei\_time|Date|订购日期|是|
|8|feijipiao\_order\_types|Integer|订单类型|是|
|9|feijipiao\_order\_payment\_types|Integer|支付类型|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|hangbanguanlidongtai\_name|String|动态名称|是|
|3|hangbanguanlidongtai\_photo|String|动态图片|是|
|4|hangbanguanlidongtai\_types|Integer|动态类型|是|
|5|insert\_time|Date|发布时间|是|
|6|hangbanguanlidongtai\_content|String|航班管理动态详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|shiyongbangzhu\_name|String|帮助名称|是|
|3|shiyongbangzhu\_photo|String|帮助图片|是|
|4|shiyongbangzhu\_types|Integer|帮助类型|是|
|5|shiyongbangzhu\_content|String|使用帮助详情|是|
...
|3|kehu\_phone|String|客户手机号|是|
|4|kehu\_id\_number|String|客户身份证号|是|
|5|kehu\_photo|String|客户头像|是|
|6|kehu\_email|String|电子邮箱|是|
|7|new\_money|BigDecimal|余额|是|
|8|kehu\_sum\_jifen|BigDecimal|总积分|是|
|9|kehu\_new\_jifen|BigDecimal|现积分|是|
